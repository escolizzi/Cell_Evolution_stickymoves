    ...
    for i in range(-1,2):
        for j in range(-1,2):
            ...
            try: 
                r,g,b,alpha = image.getpixel((x+i,y+j))
                # print "x,y=",x,y,"rgb=",r,g,b
                if not(r==200 and g==30 and b==30) and not(r==0 and g==0 and b==0):
                    # print "got yellow nei"
                    return True
            except:
                pass    
...
ax.imshow(blacks,origin='lower',extent=[0, width/2, 0, height/2],zorder=1,interpolation='none') #extent specifies the coordinates of the boundaries of the picture, 
